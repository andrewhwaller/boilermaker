...
class BoxPanelTest < ComponentTestCase
  ...
  test "renders successfully" do
    panel = Components::BoxPanel.new(title: "Settings")
  ...
  test "renders title text" do
    panel = Components::BoxPanel.new(title: "User Options")

    assert_has_text(panel, "User Options")
  end

  test "applies accent border" do
    panel = Components::BoxPanel.new(title: "Test")
  ...
  test "yields block content" do
    html = render_component(
      Components::BoxPanel.new(title: "Options")
  ...
  test "renders with empty content" do
    panel = Components::BoxPanel.new(title: "Empty")
