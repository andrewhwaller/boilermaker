...
class KbdHintTest < ComponentTestCase
  ...
  test "renders successfully" do
    hint = Components::KbdHint.new(key: "Ctrl+C")
  ...
  test "renders kbd element" do
    hint = Components::KbdHint.new(key: "Enter")

    assert_has_tag(hint, "kbd")
  end

  test "renders key text" do
    hint = Components::KbdHint.new(key: "Esc")

    assert_has_text(hint, "Esc")
  end

  test "applies font-mono styling" do
    hint = Components::KbdHint.new(key: "Tab")
  ...
  test "renders single key" do
    hint = Components::KbdHint.new(key: "K")
  ...
  test "renders key combination" do
    hint = Components::KbdHint.new(key: "Ctrl+Shift+P")
