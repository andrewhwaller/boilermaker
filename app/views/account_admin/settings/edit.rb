            ...
            div(class: "space-y-6") do
              ...
              div(class: "flex items-center justify-between mb-6") do
                ...
                div(class: "flex gap-2") do
                  link_to("View Settings", account_admin_settings_path, class: "btn btn-outline")
              ...
              card do
                ...
                form_with(model: @account, url: account_admin_settings_path, local: true, class: "space-y-4") do |f|
                  # Account name field
                  div do
                  ...
                  div(class: "flex gap-3 pt-4") do
                    ...
                    link_to("Cancel", account_admin_settings_path, class: "btn btn-outline")
                  end
                end
              end
